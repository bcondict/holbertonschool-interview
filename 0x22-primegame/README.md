...
Frist round: `4`
- Maria picks 2 and removes 2, 4, leaging 1, 3
- Ben picks 3 and removes 3, leavin 1
- Ben wins because there are no prime numbers left for Maria to choose

Second round: `5`
- Marian picks 2 and removes 2, 4, leaving 1, 3, 5
...
### Usage
The result of the task is on the file `main_0.py`.
```bash
$ ./main_0.py
Winner: Ben
```
