...
Files `1-mul` and `2-mul` are my first attemps to solve it, but I didn't wanted to delete them, I spend some tome on it and I think it is a good idea to keep them.
Anyways holberton only accept the solution on `0-mul.c` file.
...
Write a program that muiltiplies twto positive number:
- Usage: `mul num1 num2`
